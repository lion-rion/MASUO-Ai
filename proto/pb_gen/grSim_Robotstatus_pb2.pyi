...
class Robots_Status(google.protobuf.message.Message):
    ...
    def __init__(self, *, robots_status: typing.Optional[typing.Iterable[global___Robot_Status]]=...) -> None:
        ...
...
class Robot_Status(google.protobuf.message.Message):
    ...
    def __init__(self, *, robot_id: typing.Optional[builtins.int]=..., infrared: typing.Optional[builtins.bool]=..., flat_kick: typing.Optional[builtins.bool]=..., chip_kick: typing.Optional[builtins.bool]=...) -> None:
        ...
