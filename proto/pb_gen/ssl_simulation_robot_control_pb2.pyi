...
class RobotCommand(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: typing.Optional[builtins.int]=..., move_command: typing.Optional[global___RobotMoveCommand]=..., kick_speed: typing.Optional[builtins.float]=..., kick_angle: typing.Optional[builtins.float]=..., dribbler_speed: typing.Optional[builtins.float]=...) -> None:
        ...
...
class RobotMoveCommand(google.protobuf.message.Message):
    ...
    def __init__(self, *, wheel_velocity: typing.Optional[global___MoveWheelVelocity]=..., local_velocity: typing.Optional[global___MoveLocalVelocity]=..., global_velocity: typing.Optional[global___MoveGlobalVelocity]=...) -> None:
        ...
...
class MoveLocalVelocity(google.protobuf.message.Message):
    ...
    def __init__(self, *, forward: typing.Optional[builtins.float]=..., left: typing.Optional[builtins.float]=..., angular: typing.Optional[builtins.float]=...) -> None:
        ...
...
class MoveGlobalVelocity(google.protobuf.message.Message):
    ...
    def __init__(self, *, x: typing.Optional[builtins.float]=..., y: typing.Optional[builtins.float]=..., angular: typing.Optional[builtins.float]=...) -> None:
        ...
...
class RobotControl(google.protobuf.message.Message):
    ...
    def __init__(self, *, robot_commands: typing.Optional[typing.Iterable[global___RobotCommand]]=...) -> None:
        ...
