...
from . import ssl_simulation_config_pb2
from . import ssl_simulation_error_pb2
import typing
...
class TeleportBall(google.protobuf.message.Message):
    ...
    def __init__(self, *, x: typing.Optional[builtins.float]=..., y: typing.Optional[builtins.float]=..., z: typing.Optional[builtins.float]=..., vx: typing.Optional[builtins.float]=..., vy: typing.Optional[builtins.float]=..., vz: typing.Optional[builtins.float]=..., teleport_safely: typing.Optional[builtins.bool]=..., roll: typing.Optional[builtins.bool]=..., by_force: typing.Optional[builtins.bool]=...) -> None:
        ...
...
class TeleportRobot(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: typing.Optional[ssl_gc_common_pb2.RobotId]=..., x: typing.Optional[builtins.float]=..., y: typing.Optional[builtins.float]=..., orientation: typing.Optional[builtins.float]=..., v_x: typing.Optional[builtins.float]=..., v_y: typing.Optional[builtins.float]=..., v_angular: typing.Optional[builtins.float]=..., present: typing.Optional[builtins.bool]=..., by_force: typing.Optional[builtins.bool]=...) -> None:
        ...
...
class SimulatorControl(google.protobuf.message.Message):
    ...
    def __init__(self, *, teleport_ball: typing.Optional[global___TeleportBall]=..., teleport_robot: typing.Optional[typing.Iterable[global___TeleportRobot]]=..., simulation_speed: typing.Optional[builtins.float]=...) -> None:
        ...
...
class SimulatorCommand(google.protobuf.message.Message):
    ...
    def __init__(self, *, control: typing.Optional[global___SimulatorControl]=..., config: typing.Optional[ssl_simulation_config_pb2.SimulatorConfig]=...) -> None:
        ...
...
class SimulatorResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, errors: typing.Optional[typing.Iterable[ssl_simulation_error_pb2.SimulatorError]]=...) -> None:
        ...
