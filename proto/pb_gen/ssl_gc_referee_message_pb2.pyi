...
class Referee(google.protobuf.message.Message):
    ...
    class TeamInfo(google.protobuf.message.Message):
        ...
        def __init__(self, *, name: typing.Optional[typing.Text]=..., score: typing.Optional[builtins.int]=..., red_cards: typing.Optional[builtins.int]=..., yellow_card_times: typing.Optional[typing.Iterable[builtins.int]]=..., yellow_cards: typing.Optional[builtins.int]=..., timeouts: typing.Optional[builtins.int]=..., timeout_time: typing.Optional[builtins.int]=..., goalkeeper: typing.Optional[builtins.int]=..., foul_counter: typing.Optional[builtins.int]=..., ball_placement_failures: typing.Optional[builtins.int]=..., can_place_ball: typing.Optional[builtins.bool]=..., max_allowed_bots: typing.Optional[builtins.int]=..., bot_substitution_intent: typing.Optional[builtins.bool]=..., ball_placement_failures_reached: typing.Optional[builtins.bool]=...) -> None:
            ...
    ...
    def __init__(self, *, source_identifier: typing.Optional[typing.Text]=..., match_type: typing.Optional[global___MatchType.ValueType]=..., packet_timestamp: typing.Optional[builtins.int]=..., stage: typing.Optional[global___Referee.Stage.ValueType]=..., stage_time_left: typing.Optional[builtins.int]=..., command: typing.Optional[global___Referee.Command.ValueType]=..., command_counter: typing.Optional[builtins.int]=..., command_timestamp: typing.Optional[builtins.int]=..., yellow: typing.Optional[global___Referee.TeamInfo]=..., blue: typing.Optional[global___Referee.TeamInfo]=..., designated_position: typing.Optional[global___Referee.Point]=..., blue_team_on_positive_half: typing.Optional[builtins.bool]=..., next_command: typing.Optional[global___Referee.Command.ValueType]=..., game_events: typing.Optional[typing.Iterable[ssl_gc_game_event_pb2.GameEvent]]=..., game_event_proposals: typing.Optional[typing.Iterable[global___GameEventProposalGroup]]=..., current_action_time_remaining: typing.Optional[builtins.int]=...) -> None:
        ...
...
class GameEventProposalGroup(google.protobuf.message.Message):
    ...
    def __init__(self, *, game_event: typing.Optional[typing.Iterable[ssl_gc_game_event_pb2.GameEvent]]=..., accepted: typing.Optional[builtins.bool]=...) -> None:
        ...
