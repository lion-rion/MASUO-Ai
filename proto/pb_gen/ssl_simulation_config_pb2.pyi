...
class RobotLimits(google.protobuf.message.Message):
    ...
    def __init__(self, *, acc_speedup_absolute_max: typing.Optional[builtins.float]=..., acc_speedup_angular_max: typing.Optional[builtins.float]=..., acc_brake_absolute_max: typing.Optional[builtins.float]=..., acc_brake_angular_max: typing.Optional[builtins.float]=..., vel_absolute_max: typing.Optional[builtins.float]=..., vel_angular_max: typing.Optional[builtins.float]=...) -> None:
        ...
...
class RobotWheelAngles(google.protobuf.message.Message):
    ...
    def __init__(self, *, front_right: typing.Optional[builtins.float]=..., back_right: typing.Optional[builtins.float]=..., back_left: typing.Optional[builtins.float]=..., front_left: typing.Optional[builtins.float]=...) -> None:
        ...
...
class RobotSpecs(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: typing.Optional[ssl_gc_common_pb2.RobotId]=..., radius: typing.Optional[builtins.float]=..., height: typing.Optional[builtins.float]=..., mass: typing.Optional[builtins.float]=..., max_linear_kick_speed: typing.Optional[builtins.float]=..., max_chip_kick_speed: typing.Optional[builtins.float]=..., center_to_dribbler: typing.Optional[builtins.float]=..., limits: typing.Optional[global___RobotLimits]=..., wheel_angles: typing.Optional[global___RobotWheelAngles]=..., custom: typing.Optional[typing.Iterable[google.protobuf.any_pb2.Any]]=...) -> None:
        ...
...
class RealismConfig(google.protobuf.message.Message):
    ...
    def __init__(self, *, custom: typing.Optional[typing.Iterable[google.protobuf.any_pb2.Any]]=...) -> None:
        ...
...
class SimulatorConfig(google.protobuf.message.Message):
    ...
    def __init__(self, *, geometry: typing.Optional[ssl_vision_geometry_pb2.SSL_GeometryData]=..., robot_specs: typing.Optional[typing.Iterable[global___RobotSpecs]]=..., realism_config: typing.Optional[global___RealismConfig]=..., vision_port: typing.Optional[builtins.int]=...) -> None:
        ...
