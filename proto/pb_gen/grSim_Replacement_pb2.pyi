...
class grSim_RobotReplacement(google.protobuf.message.Message):
    ...
    def __init__(self, *, x: typing.Optional[builtins.float]=..., y: typing.Optional[builtins.float]=..., dir: typing.Optional[builtins.float]=..., id: typing.Optional[builtins.int]=..., yellowteam: typing.Optional[builtins.bool]=..., turnon: typing.Optional[builtins.bool]=...) -> None:
        ...
...
class grSim_BallReplacement(google.protobuf.message.Message):
    ...
    def __init__(self, *, x: typing.Optional[builtins.float]=..., y: typing.Optional[builtins.float]=..., vx: typing.Optional[builtins.float]=..., vy: typing.Optional[builtins.float]=...) -> None:
        ...
...
class grSim_Replacement(google.protobuf.message.Message):
    ...
    def __init__(self, *, ball: typing.Optional[global___grSim_BallReplacement]=..., robots: typing.Optional[typing.Iterable[global___grSim_RobotReplacement]]=...) -> None:
        ...
