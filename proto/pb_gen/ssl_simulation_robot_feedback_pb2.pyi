...
class RobotFeedback(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: typing.Optional[builtins.int]=..., dribbler_ball_contact: typing.Optional[builtins.bool]=..., custom: typing.Optional[google.protobuf.any_pb2.Any]=...) -> None:
        ...
...
class RobotControlResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, errors: typing.Optional[typing.Iterable[ssl_simulation_error_pb2.SimulatorError]]=..., feedback: typing.Optional[typing.Iterable[global___RobotFeedback]]=...) -> None:
        ...
