...
class Vector2f(google.protobuf.message.Message):
    ...
    def __init__(self, *, x: typing.Optional[builtins.float]=..., y: typing.Optional[builtins.float]=...) -> None:
        ...
...
class SSL_FieldLineSegment(google.protobuf.message.Message):
    ...
    def __init__(self, *, name: typing.Optional[typing.Text]=..., p1: typing.Optional[global___Vector2f]=..., p2: typing.Optional[global___Vector2f]=..., thickness: typing.Optional[builtins.float]=..., type: typing.Optional[global___SSL_FieldShapeType.ValueType]=...) -> None:
        ...
...
class SSL_FieldCircularArc(google.protobuf.message.Message):
    ...
    def __init__(self, *, name: typing.Optional[typing.Text]=..., center: typing.Optional[global___Vector2f]=..., radius: typing.Optional[builtins.float]=..., a1: typing.Optional[builtins.float]=..., a2: typing.Optional[builtins.float]=..., thickness: typing.Optional[builtins.float]=..., type: typing.Optional[global___SSL_FieldShapeType.ValueType]=...) -> None:
        ...
...
class SSL_GeometryFieldSize(google.protobuf.message.Message):
    ...
    def __init__(self, *, field_length: typing.Optional[builtins.int]=..., field_width: typing.Optional[builtins.int]=..., goal_width: typing.Optional[builtins.int]=..., goal_depth: typing.Optional[builtins.int]=..., boundary_width: typing.Optional[builtins.int]=..., field_lines: typing.Optional[typing.Iterable[global___SSL_FieldLineSegment]]=..., field_arcs: typing.Optional[typing.Iterable[global___SSL_FieldCircularArc]]=..., penalty_area_depth: typing.Optional[builtins.int]=..., penalty_area_width: typing.Optional[builtins.int]=..., center_circle_radius: typing.Optional[builtins.int]=..., line_thickness: typing.Optional[builtins.int]=..., goal_center_to_penalty_mark: typing.Optional[builtins.int]=..., goal_height: typing.Optional[builtins.int]=..., ball_radius: typing.Optional[builtins.float]=..., max_robot_radius: typing.Optional[builtins.float]=...) -> None:
        ...
...
class SSL_GeometryCameraCalibration(google.protobuf.message.Message):
    ...
    def __init__(self, *, camera_id: typing.Optional[builtins.int]=..., focal_length: typing.Optional[builtins.float]=..., principal_point_x: typing.Optional[builtins.float]=..., principal_point_y: typing.Optional[builtins.float]=..., distortion: typing.Optional[builtins.float]=..., q0: typing.Optional[builtins.float]=..., q1: typing.Optional[builtins.float]=..., q2: typing.Optional[builtins.float]=..., q3: typing.Optional[builtins.float]=..., tx: typing.Optional[builtins.float]=..., ty: typing.Optional[builtins.float]=..., tz: typing.Optional[builtins.float]=..., derived_camera_world_tx: typing.Optional[builtins.float]=..., derived_camera_world_ty: typing.Optional[builtins.float]=..., derived_camera_world_tz: typing.Optional[builtins.float]=..., pixel_image_width: typing.Optional[builtins.int]=..., pixel_image_height: typing.Optional[builtins.int]=...) -> None:
        ...
...
class SSL_BallModelStraightTwoPhase(google.protobuf.message.Message):
    ...
    def __init__(self, *, acc_slide: typing.Optional[builtins.float]=..., acc_roll: typing.Optional[builtins.float]=..., k_switch: typing.Optional[builtins.float]=...) -> None:
        ...
...
class SSL_BallModelChipFixedLoss(google.protobuf.message.Message):
    ...
    def __init__(self, *, damping_xy_first_hop: typing.Optional[builtins.float]=..., damping_xy_other_hops: typing.Optional[builtins.float]=..., damping_z: typing.Optional[builtins.float]=...) -> None:
        ...
...
class SSL_GeometryModels(google.protobuf.message.Message):
    ...
    def __init__(self, *, straight_two_phase: typing.Optional[global___SSL_BallModelStraightTwoPhase]=..., chip_fixed_loss: typing.Optional[global___SSL_BallModelChipFixedLoss]=...) -> None:
        ...
...
class SSL_GeometryData(google.protobuf.message.Message):
    ...
    def __init__(self, *, field: typing.Optional[global___SSL_GeometryFieldSize]=..., calib: typing.Optional[typing.Iterable[global___SSL_GeometryCameraCalibration]]=..., models: typing.Optional[global___SSL_GeometryModels]=...) -> None:
        ...
